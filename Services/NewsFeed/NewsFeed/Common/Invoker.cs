...
namespace NewsFeed.Common
{
    public class Invoker
    {
        ...
        /// <returns></returns>
        private bool CheckTypeNameOfParams(Type[] paramTypes, Type[] incomParamTypes)
        {
        ...
        /// <returns></returns>
        private bool CheckMethod(Tuple<Type, object>[] incomingParams, ParameterInfo[] parametersOfMethod)
        {
        ...
        /// <returns></returns>
        private bool CheckParameters(Type[] incomParamTypes, Type[] paramTypes)
        {
        ...
        /// <param name="paramTypes">Типы параметров проверяемого метода</param>
        /// <returns></returns>
        private bool CheckGenericParams(Type incomParamType, Type[] paramTypes)
        {
